...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','phone', 'email', 'username', 'password', 'token']

    def create(self, validated_data):
        # Using the `create_user` method to create a new user.
...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        # we pass `phone` as the `username` value since in our User
        # model we set `USERNAME_FIELD` as `phone`.
        ...
        if user is None:
            raise serializers.ValidationError(
                'A user with this phone and password was not found.'
            )
